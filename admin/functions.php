...
function project($name, $image, $id, $ajax){
...
function mainproject($name, $image, $id){
    ...
    <div class="col-lg-3 col-md-4 col-10 mx-auto">
        <div class="card gallery-card p-1">
...
function skillsModal(){
    $element='
   <div class="main-modal-box" style="height:fit-content !important;">
          <div class="d-block px-3 p-3">
            <div class="text-end text-light" id="modal-close" style="cursor:pointer !important;">big</div>
    ...
    $element='
        <div class="col-lg-4 col-md-4 col-6 m-auto gy-4 p-1 p-md-2 p-lg-3">
            <div class="card icon-card-1" id="fullstack">
                ...
                <p class="position-relative px-4" style="width:100%;height:100%;color:crimson;">learn more <p class="text-start project-second-text admin-skills-btn position-absolute" style="color:crimson;opacity:0;bottom:15px;left:16px;">learn more '.$id.'</p></p>
